...
*/
#define CH_CURRENT_SetHigh()          _LATA0 = 1
/**
  @Summary
...
*/
#define CH_CURRENT_SetLow()           _LATA0 = 0
/**
  @Summary
...
*/
#define CH_CURRENT_Toggle()           _LATA0 ^= 1
/**
  @Summary
  ...
  @Example
    ...
    // Read RA0
    postValue = CH_CURRENT_GetValue();
    </code>

*/
#define CH_CURRENT_GetValue()         _RA0
/**
  @Summary
  ...
  @Example
    ...
    CH_CURRENT_SetDigitalInput();
    </code>

*/
#define CH_CURRENT_SetDigitalInput()  _TRISA0 = 1
/**
  @Summary
  ...
  @Example
    ...
    CH_CURRENT_SetDigitalOutput();
    </code>

*/
#define CH_CURRENT_SetDigitalOutput() _TRISA0 = 0
/**
  @Summary
...
*/
#define CH_POT_SetHigh()          _LATA1 = 1
/**
  @Summary
...
/**
  ...
  @Example
    ...
    // Read RA1
    postValue = CH_POT_GetValue();
    </code>

*/
#define CH_POT_GetValue()         _RA1
/**
  @Summary
  ...
  @Example
    ...
    CH_POT_SetDigitalInput();
    </code>

*/
#define CH_POT_SetDigitalInput()  _TRISA1 = 1
/**
  @Summary
  ...
  @Example
    ...
    CH_POT_SetDigitalOutput();
    </code>

*/
#define CH_POT_SetDigitalOutput() _TRISA1 = 0
/**
  @Summary
...
*/
#define IO_QEIA_SetHigh()          _LATB10 = 1
/**
  @Summary
...
*/
#define IO_QEIA_SetLow()           _LATB10 = 0
/**
  @Summary
...
*/
#define IO_QEIA_Toggle()           _LATB10 ^= 1
/**
  @Summary
  ...
  @Example
    ...
    // Read RB10
    postValue = IO_QEIA_GetValue();
    </code>

*/
#define IO_QEIA_GetValue()         _RB10
/**
  @Summary
  ...
  @Example
    ...
    IO_QEIA_SetDigitalInput();
    </code>

*/
#define IO_QEIA_SetDigitalInput()  _TRISB10 = 1
/**
  @Summary
  ...
  @Example
    ...
    IO_QEIA_SetDigitalOutput();
    </code>

*/
#define IO_QEIA_SetDigitalOutput() _TRISB10 = 0
/**
  @Summary
...
*/
#define IO_QEIB_SetHigh()          _LATB11 = 1
/**
  @Summary
...
*/
#define IO_QEIB_SetLow()           _LATB11 = 0
/**
  @Summary
...
*/
#define IO_QEIB_Toggle()           _LATB11 ^= 1
/**
  @Summary
  ...
  @Example
    ...
    // Read RB11
    postValue = IO_QEIB_GetValue();
    </code>

*/
#define IO_QEIB_GetValue()         _RB11
/**
  @Summary
  ...
  @Example
    ...
    IO_QEIB_SetDigitalInput();
    </code>

*/
#define IO_QEIB_SetDigitalInput()  _TRISB11 = 1
/**
  @Summary
  ...
  @Example
    ...
    IO_QEIB_SetDigitalOutput();
    </code>

*/
#define IO_QEIB_SetDigitalOutput() _TRISB11 = 0
/**
  @Summary
  ...
  @Example
    <code>
    // Set RB2 high (1)
    CH_COMMUTATION_SetHigh();
    </code>

*/
#define CH_COMMUTATION_SetHigh()          _LATB2 = 1
/**
  @Summary
  ...
  @Example
    <code>
    // Set RB2 low (0)
    CH_COMMUTATION_SetLow();
    </code>

*/
#define CH_COMMUTATION_SetLow()           _LATB2 = 0
/**
  @Summary
  ...
  @Example
    <code>
    // Toggle RB2
    CH_COMMUTATION_Toggle();
    </code>

*/
#define CH_COMMUTATION_Toggle()           _LATB2 ^= 1
/**
  @Summary
  ...
  @Example
    ...
    // Read RB2
    postValue = CH_COMMUTATION_GetValue();
    </code>

*/
#define CH_COMMUTATION_GetValue()         _RB2
/**
  @Summary
  ...
  @Example
    ...
    CH_COMMUTATION_SetDigitalInput();
    </code>

*/
#define CH_COMMUTATION_SetDigitalInput()  _TRISB2 = 1
/**
  @Summary
  ...
  @Example
    ...
    CH_COMMUTATION_SetDigitalOutput();
    </code>

*/
#define CH_COMMUTATION_SetDigitalOutput() _TRISB2 = 0
/**
  @Summary
...
*/
#define CH_VOLTAGE_SetHigh()          _LATB3 = 1
/**
  @Summary
...
*/
#define CH_VOLTAGE_SetLow()           _LATB3 = 0
/**
  @Summary
...
*/
#define CH_VOLTAGE_Toggle()           _LATB3 ^= 1
/**
  @Summary
  ...
  @Example
    ...
    // Read RB3
    postValue = CH_VOLTAGE_GetValue();
    </code>

*/
#define CH_VOLTAGE_GetValue()         _RB3
/**
  @Summary
  ...
  @Example
    ...
    CH_VOLTAGE_SetDigitalInput();
    </code>

*/
#define CH_VOLTAGE_SetDigitalInput()  _TRISB3 = 1
/**
  @Summary
  ...
  @Example
    ...
    CH_VOLTAGE_SetDigitalOutput();
    </code>

*/
#define CH_VOLTAGE_SetDigitalOutput() _TRISB3 = 0
/**
  @Summary
